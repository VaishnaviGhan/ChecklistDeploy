...
from .forms import ProjectForm,stucturalElemForm,SiteForm,DepartmentForm,EditUserForm,UserMasterForm,CheckList_HeaderForm,CheckList_FooterForm,CheckList_Trans_HeaderForm,UserRightsForm,addUserForm
from django.contrib import messages
from .models import Project_Master,CustomUser,Site_Master,CheckList_Header,CheckList_Footer,Structural_Element,History
...
def add_project(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return HttpResponse('add_project')
        ...
        return render(request, 'checkapp/add_project.html', context)
...
def edit_project(request,pk):
    ...
    return render(request, 'checkapp/editProjectForm.html', {'editprojectform': editprojectform, 'project': project,'isActive': True,'page_title': 'Ashoka Buildcon Limited',
                'customer_name' : 'Ashoka Buildcon Limited'})
...
def add_site(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'checkapp/add_site.html', context)
...
def edit_site(request,pk):
    ...
    return render(request, 'checkapp/editSiteForm.html', {'editsiteform': editsiteform, 'site': site,'isActive': True,'page_title': 'Ashoka Buildcon Limited',
                'customer_name' : 'Ashoka Buildcon Limited'})
...
def add_department(request):
    if request.method == 'POST':
        ...
        return render(request, 'checkapp/add_department.html', context)   
...
def Add_CheckList_Header(request):
    ...
    return render(request, 'checkapp/Add_CheckList_HeaderForm.html', context)
...
def edit_CheckList_Header(request,pk):
     ...
     return render(request, 'checkapp/editchecklist_NameForm.html', {'editchecklist_headerform': editchecklist_headerform, 'checklist': checklist,'isActive': True,'page_title': 'Ashoka Buildcon Limited',
                'customer_name' : 'Ashoka Buildcon Limited'})
...
def Add_CheckList_Footer(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'checkapp/Add_CheckList_Footer.html', context)
...
def edit_CheckList_Footer(request,pk):
     ...
     return render(request, 'checkapp/editchecklist_QuestionForm.html', {'editchecklist_Questionform': editchecklist_Questionform, 'checklistQues': checklistQues,'isActive': True,'page_title': 'Ashoka Buildcon Limited',
                'customer_name' : 'Ashoka Buildcon Limited'})
...
def Add_CheckList_Trans_Header(request):
    if request.method == 'POST':
        ...
        return render(request, 'checkapp/Add_CheckList_Trans_Header.html', context)   
...
def Add_Structural_Elements(request):
    ...
    if request.method == 'POST':
        ...
        return render(request,'checkapp/AddStructuralElement.html', context)
...
def edit_Structural_Elements(request,pk):
     ...
     return render(request, 'checkapp/editStructural_ElemForm.html', {'editstructural_elem': editstructural_elem, 'element': element,'isActive': True,'page_title': 'Ashoka Buildcon Limited',
                'customer_name' : 'Ashoka Buildcon Limited'})
...
def User_Rights(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            History.objects.create(Doc_ID=f"given user rights",Comment=f"{request.user} given user rights..!")
            
            messages.info(request,'UserRights added successfully')
            return redirect('User_Rights')
        else:
            messages.warning(request, 'Something went wrong! Please check form input.')
            return HttpResponse('User_Rights')
        ...
        return render(request, 'checkapp/UserRightsForm.html', context)
...
def addUser(request):
    ...
    return render(request, 'checkapp/addUserForm.html', context)
...
def edit_user(request,user_id):
    ...
    return render(request, 'checkapp/editUserForm.html', {'edituserform': edituserform, 'user': user,'isActive': True,'page_title': 'Ashoka Buildcon Limited',
                'customer_name' : 'Ashoka Buildcon Limited'})
...
def UserMaster(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            History.objects.create(Doc_ID=f"given access",Comment=f"{request.user} given access")
            
            messages.info(request,'given access to user successfully')
            return redirect('usermaster')
        else:
            messages.warning(request, 'Something went wrong! Please check form input.')
            return HttpResponse('usermaster')
        ...
        return render(request, 'checkapp/UserMasterForm.html', context)
...
def history(request):
    ...
    return render(request,'checkapp/history.html', context)
